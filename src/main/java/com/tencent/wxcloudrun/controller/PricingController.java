...
public class PricingController {
    ...
    public ApiResponse createPricingDetail(@RequestBody PricingDetailRequest request) {
        ...
        return ApiResponse.ok("价格设置成功");
    }

    @PostMapping("/weekday")
    public ApiResponse setWeekdayPrices(@RequestBody BatchPriceRequest request) {
        ...
        return ApiResponse.ok("工作日价格设置成功");
    }

    @PostMapping("/weekend")
    public ApiResponse setWeekendPrices(@RequestBody BatchPriceRequest request) {
    ...
    public ApiResponse getPrices(
        ...
        return ApiResponse.ok(pricingService.getPricesByConditions(courtId, timeSlotId, periodType, dayType));
    }
